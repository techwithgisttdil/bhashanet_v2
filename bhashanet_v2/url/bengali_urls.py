...
Translation_urlpatterns_bengali = [
    ...
    path('add_blogbn', preprocesslangset(user_views.add_blog), name='add_blog'),
    path('edit_blogbn/<str:id>',preprocesslangset( user_views.edit_blog), name='edit_blog'),
    path('delete_blogbn/<str:id>', preprocesslangset(user_views.delete_blog), name='delete_blog'),
    path('blog_datatablebn', preprocesslangset(user_views.admin_blog_datatable), name='admin_blog_datatable'),
