...
Translation_urlpatterns_malayalam = [
    ...
    path('add_blogml', preprocesslangset(user_views.add_blog), name='add_blog'),
    path('edit_blogml/<str:id>', preprocesslangset(user_views.edit_blog), name='edit_blog'),
    path('delete_blogml/<str:id>', preprocesslangset(user_views.delete_blog), name='delete_blog'),
    path('blog_datatableml', preprocesslangset(user_views.admin_blog_datatable), name='admin_blog_datatable'),
