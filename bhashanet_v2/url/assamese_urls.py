...
Translation_urlpatterns_assamese = [
    ...
    path('add_blogas', preprocesslangset(core_views.add_blog), name='add_blog'),
    path('edit_blogas/<str:id>', preprocesslangset(core_views.edit_blog), name='edit_blog'),
    path('delete_blogas/<str:id>', preprocesslangset(core_views.delete_blog), name='delete_blog'),
    path('blog_datatableas', preprocesslangset(core_views.admin_blog_datatable), name='admin_blog_datatable'),
