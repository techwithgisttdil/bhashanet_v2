...
Translation_urlpatterns_telugu = [
    ...
    path('add_blogte',preprocesslangset( user_views.add_blog), name='add_blog'),
    path('edit_blogte/<str:id>', preprocesslangset(user_views.edit_blog), name='edit_blog'),
    path('delete_blogte/<str:id>', preprocesslangset(user_views.delete_blog), name='delete_blog'),
    path('blog_datatablete', preprocesslangset(user_views.admin_blog_datatable), name='admin_blog_datatable'),
