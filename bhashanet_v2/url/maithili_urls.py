...
Translation_urlpatterns_maithili = [
    ...
    path('add_blogmai',preprocesslangset( core_views.add_blog), name='add_blog'),
    path('edit_blogmai/<str:id>',preprocesslangset( core_views.edit_blog), name='edit_blog'),
    path('delete_blogmai/<str:id>',preprocesslangset( core_views.delete_blog), name='delete_blog'),
    path('blog_datatablemai',preprocesslangset( core_views.admin_blog_datatable), name='admin_blog_datatable'),
