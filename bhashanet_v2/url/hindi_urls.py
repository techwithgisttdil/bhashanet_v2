...
Translation_urlpatterns_hindi = [
    ...
    path('add_bloghi', preprocesslangset(core_views.add_blog), name='add_blog'),
    path('edit_bloghi/<str:id>', preprocesslangset(core_views.edit_blog), name='edit_blog'),
    path('delete_bloghi/<str:id>', preprocesslangset(core_views.delete_blog), name='delete_blog'),
    path('blog_datatablehi', preprocesslangset(core_views.admin_blog_datatable), name='admin_blog_datatable'),
