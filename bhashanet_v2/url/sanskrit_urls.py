...
Translation_urlpatterns_sanskrit = [
    ...
    path('add_blogsa', preprocesslangset(core_views.add_blog), name='add_blog'),
    path('edit_blogsa/<str:id>', preprocesslangset(core_views.edit_blog), name='edit_blog'),
    path('delete_blogsa/<str:id>',preprocesslangset( core_views.delete_blog), name='delete_blog'),
    path('blog_datatablesa',preprocesslangset( core_views.admin_blog_datatable), name='admin_blog_datatable'),
    ...
    path('test_tasksa', preprocesslangset(core_views.test_celery), name="test_task"),
