...
Translation_urlpatterns_punjabi = [
    ...
    path('add_blogpa', preprocesslangset(user_views.add_blog), name='add_blog'),
    path('edit_blogpa/<str:id>',preprocesslangset( user_views.edit_blog), name='edit_blog'),
    path('delete_blogpa/<str:id>', preprocesslangset(user_views.delete_blog), name='delete_blog'),
    path('blog_datatablepa', preprocesslangset(user_views.admin_blog_datatable), name='admin_blog_datatable'),
