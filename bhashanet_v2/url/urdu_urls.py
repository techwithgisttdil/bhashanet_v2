...
Translation_urlpatterns_urdu = [
    ...
    path('add_blogur', preprocesslangset(core_views.add_blog), name='add_blog'),
    path('edit_blogur/<str:id>',preprocesslangset( core_views.edit_blog), name='edit_blog'),
    path('delete_blogur/<str:id>', preprocesslangset(core_views.delete_blog), name='delete_blog'),
    path('blog_datatableur', preprocesslangset(core_views.admin_blog_datatable), name='admin_blog_datatable'),
