...
Translation_urlpatterns_dogri = [
    ...
    path('add_blogdoi', preprocesslangset(core_views.add_blog), name='add_blog'),
    path('edit_blogdoi/<str:id>', preprocesslangset(core_views.edit_blog), name='edit_blog'),
    path('delete_blogdoi/<str:id>', preprocesslangset(core_views.delete_blog), name='delete_blog'),
    path('blog_datatabledoi', preprocesslangset(core_views.admin_blog_datatable), name='admin_blog_datatable'),
