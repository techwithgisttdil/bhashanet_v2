...
Translation_urlpatterns_oriya = [
    ...
    path('add_blogor', preprocesslangset(core_views.add_blog), name='add_blog'),
    path('edit_blogor/<str:id>', preprocesslangset(core_views.edit_blog), name='edit_blog'),
    path('delete_blogor/<str:id>',preprocesslangset( core_views.delete_blog), name='delete_blog'),
    path('blog_datatableor',preprocesslangset( core_views.admin_blog_datatable), name='admin_blog_datatable'),
    ...
    path('test_taskor', preprocesslangset(core_views.test_celery), name="test_task"),
