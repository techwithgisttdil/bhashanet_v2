...
Translation_urlpatterns_nepali = [
    ...
    path('add_blogne',preprocesslangset( core_views.add_blog), name='add_blog'),
    path('edit_blogne/<str:id>',preprocesslangset(core_views.edit_blog), name='edit_blog'),
    path('delete_blogne/<str:id>', preprocesslangset(core_views.delete_blog), name='delete_blog'),
    path('blog_datatablene',preprocesslangset( core_views.admin_blog_datatable), name='admin_blog_datatable'),
    ...
    path('test_taskne',preprocesslangset( core_views.test_celery), name="test_task"),
