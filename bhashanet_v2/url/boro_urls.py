...
Translation_urlpatterns_boro = [
    ...
    path('add_blogbrx', preprocesslangset(user_views.add_blog), name='add_blog'),
    path('edit_blogbrx/<str:id>', preprocesslangset(user_views.edit_blog), name='edit_blog'),
    path('delete_blogbrx/<str:id>', preprocesslangset(user_views.delete_blog), name='delete_blog'),
    path('blog_datatablebrx', preprocesslangset(user_views.admin_blog_datatable), name='admin_blog_datatable'),
