...
Translation_urlpatterns_tamil = [
    ...
    path('add_blogta',preprocesslangset( user_views.add_blog), name='add_blog'),
    path('edit_blogta/<str:id>', preprocesslangset(user_views.edit_blog), name='edit_blog'),
    path('delete_blogta/<str:id>', preprocesslangset(user_views.delete_blog), name='delete_blog'),
    path('blog_datatableta', preprocesslangset(user_views.admin_blog_datatable), name='admin_blog_datatable'),
