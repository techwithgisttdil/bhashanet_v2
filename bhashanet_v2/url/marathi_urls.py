...
Translation_urlpatterns_marathi = [
    ...
    path('add_blogmr', preprocesslangset(core_views.add_blog), name='add_blog'),
    path('edit_blogmr/<str:id>',preprocesslangset( core_views.edit_blog), name='edit_blog'),
    path('delete_blogmr/<str:id>',preprocesslangset( core_views.delete_blog), name='delete_blog'),
    path('blog_datatablemr', preprocesslangset(core_views.admin_blog_datatable), name='admin_blog_datatable'),
    path('search_blogmr/<str:id>',preprocesslangset( core_views.search_blog), name='search_blog'),
