...
Translation_urlpatterns_santali = [
    ...
    path('add_blogsat', preprocesslangset(user_views.add_blog), name='add_blog'),
    path('edit_blogsat/<str:id>', preprocesslangset(user_views.edit_blog), name='edit_blog'),
    path('delete_blogsat/<str:id>',preprocesslangset( user_views.delete_blog), name='delete_blog'),
    path('blog_datatablesat', preprocesslangset(user_views.admin_blog_datatable), name='admin_blog_datatable'),
