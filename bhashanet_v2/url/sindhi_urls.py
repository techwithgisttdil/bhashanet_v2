...
Translation_urlpatterns_sindhi = [
    ...
    path('add_blogsdin',preprocesslangset( core_views.add_blog), name='add_blog'),
    path('edit_blogsdin/<str:id>', preprocesslangset(core_views.edit_blog), name='edit_blog'),
    path('delete_blogsdin/<str:id>', preprocesslangset(core_views.delete_blog), name='delete_blog'),
    path('blog_datatablesdin', preprocesslangset(core_views.admin_blog_datatable), name='admin_blog_datatable'),
