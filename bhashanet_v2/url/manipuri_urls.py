...
Translation_urlpatterns_manipuri = [
    ...
    path('add_blogmni',preprocesslangset( core_views.add_blog), name='add_blog'),
    path('edit_blogmni/<str:id>', preprocesslangset(core_views.edit_blog), name='edit_blog'),
    path('delete_blogmni/<str:id>', preprocesslangset(core_views.delete_blog), name='delete_blog'),
    path('blog_datatablemni', preprocesslangset(core_views.admin_blog_datatable), name='admin_blog_datatable'),
