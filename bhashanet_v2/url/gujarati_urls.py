...
Translation_urlpatterns_gujarati = [
    ...
    path('add_bloggu',preprocesslangset( core_views.add_blog), name='add_blog'),
    path('edit_bloggu/<str:id>', preprocesslangset(core_views.edit_blog), name='edit_blog'),
    path('delete_bloggu/<str:id>',preprocesslangset( core_views.delete_blog), name='delete_blog'),
    path('blog_datatablegu',preprocesslangset( core_views.admin_blog_datatable), name='admin_blog_datatable'),
