...
Translation_urlpatterns_kannada = [
    ...
    path('ಬ್ಲಾಗ್kn/<str:id>', preprocesslangset(core_views.blog), name='blog'),
    ...
    path('add_blogkn', preprocesslangset(core_views.add_blog), name='add_blog'),
    path('edit_blogkn/<str:id>', preprocesslangset(core_views.edit_blog), name='edit_blog'),
    path('delete_blogkn/<str:id>', preprocesslangset(core_views.delete_blog), name='delete_blog'),
    path('blog_datatablekn', preprocesslangset(core_views.admin_blog_datatable), name='admin_blog_datatable'),
