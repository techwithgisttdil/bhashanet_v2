...
Translation_urlpatterns_konkani = [
    ...
    path('add_blogkok', preprocesslangset(core_views.add_blog), name='add_blog'),
    path('edit_blogkok/<str:id>', preprocesslangset(core_views.edit_blog), name='edit_blog'),
    path('delete_blogkok/<str:id>', preprocesslangset(core_views.delete_blog), name='delete_blog'),
    path('blog_datatablekok', preprocesslangset(core_views.admin_blog_datatable), name='admin_blog_datatable'),
    ...
    path('test_taskkok', preprocesslangset(core_views.test_celery), name="test_task"),
