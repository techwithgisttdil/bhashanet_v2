...
Translation_urlpatterns_kashmiri = [
    ...
    path('add_blogks',preprocesslangset( core_views.add_blog), name='add_blog'),
    path('edit_blogks/<str:id>',preprocesslangset( core_views.edit_blog), name='edit_blog'),
    path('delete_blogks/<str:id>',preprocesslangset( core_views.delete_blog), name='delete_blog'),
    path('blog_datatableks',preprocesslangset( core_views.admin_blog_datatable), name='admin_blog_datatable'),
    ...
    path('test_taskks',preprocesslangset( core_views.test_celery), name="test_task"),
