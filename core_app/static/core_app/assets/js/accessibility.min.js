...
MicAccessTool.prototype.contrastChange=function(A) {
    if(A.preventDefault(), document.body.classList.contains(this.id))this.classList.remove("vi-enabled"),
    document.body.classList.remove(this.id),
    delete window.MICTOOLBOXAPPSTATE.bodyClassList[this.id];
    else {
        for(var o=document.querySelectorAll(".mic-contrast-block button"), t=0;
        t<o.length;
        t++)o[t].classList.remove("vi-enabled"),
...
MicAccessTool.prototype.cursorChange=function(A) {
    ...
    delete window.MICTOOLBOXAPPSTATE.bodyClassList[this.id];
        ...
        for(var o=document.querySelectorAll("#mic-toolbox-cursor-big-black,#mic-toolbox-cursor-big-white"), t=0;
        t<o.length;
        t++)o[t].classList.remove("vi-enabled"),
        document.body.classList.remove(o[t].id),
        delete window.MICTOOLBOXAPPSTATE.bodyClassList[o[t].id];
...
MicAccessTool.prototype.keyboardRootEnable=function() {
    if(window.MICTOOLBOXAPPSTATE.keyboardRoot)for(var A=document.querySelectorAll("h1,h2,h3,h4,h5,h6,p,a,button,input,select,textarea"), o=0;
    o<A.length;
    o++) {
        var t=A[o];
        t.tabIndex=o+1
...
MicAccessTool.prototype.fontsChange=function(A) {
    ...
    if("mic-toolbox-fonts-up"===this.id) {
        if(o>=26||t>=1.6)return;
        for(var i=document.querySelectorAll("body,h1,h2,h3,h4,h5,h6,p,a,button,input,textarea,li,td,th,strong,span,blockquote,div"), e=0;
        e<i.length;
        e++) {
            var c=i[e],
    ...
    if("mic-toolbox-fonts-down"===this.id) {
        if(o<=16)return window.MICTOOLBOXAPPSTATE.fontSize=1,
    ...
    window.MICTOOLBOXAPPSTATE.fontSize=t,
    MicAccessTool.prototype.getFontsChanges(t),
    MicAccessTool.prototype.updateState()
}

,
MicAccessTool.prototype.initFontsChange=function() {
    for(var A=document.querySelectorAll("body,h1,h2,h3,h4,h5,h6,p,a,button,input,textarea,li,td,th,strong,span,blockquote,div"), o=window.MICTOOLBOXAPPSTATE.fontSize, t=0;
    t<A.length;
    t++) {
        var i=A[t],
...
MicAccessTool.prototype.initFontsChangeFirst=function() {
    for(var A=document.querySelectorAll("body,h1,h2,h3,h4,h5,h6,p,a,button,input,textarea,li,td,th,strong,span,blockquote,div"), o=0;
    o<A.length;
    o++) {
        var t=A[o],
...
MicAccessTool.prototype.imagesChange=function() {
    if(document.body.classList.contains("mic-toolbox-content-images")) {
        for(var A=document.querySelectorAll(".mic-toolbox-images-titles"), o=0;
        o<A.length;
        o++) {
...
MicAccessTool.prototype.imagesAddTitles=function() {
    for(var A=document.images, o=0;
    o<A.length;
    o++) {
        var t=A[o];
        if(t.alt) {
            var i=document.createElement("span");
            i.className="mic-toolbox-images-titles",
            i.textContent=t.alt,
            ...
            var i=document.createElement("span");
            i.className="mic-toolbox-images-titles",
            i.textContent="Picture without descriptions",
            t.parentNode.insertBefore(i, t)
        }
    }
}
...
MicAccessTool.prototype.initialApp=function() {
    ...
    (window.MICTOOLBOXAPPSTATE.fontSize>1&&this.initFontsChange(), window.MICTOOLBOXAPPSTATE.imagesTitle&&this.imagesAddTitles(), window.MICTOOLBOXAPPSTATE.keyboardRoot&&this.keyboardRootEnable(), !window.MSInputMethodContext||!document.documentMode)||(document.getElementById("mic-toolbox-contrast-block").style.display="none");
    if(this.init.link) {
